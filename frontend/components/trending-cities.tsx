...
export function TrendingCities() {
  ...
  return (
    <div className="w-full max-w-2xl">
      <div className="flex items-center md:ml-12 gap-2 mb-4 text-muted-foreground">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        {TRENDING_CITIES.map((city, index) => (
          <motion.button
            ...
            className="flex items-center gap-2 px-4 py-2.5 cursor-pointer rounded-full bg-white/90 dark:bg-transparent backdrop-blur-md border border-gray-200 dark:border-white/20 hover:bg-gradient-to-r hover:from-amber-50 hover:to-sky-50 dark:hover:bg-white/10 hover:border-primary/30 dark:hover:border-white/30 transition-all duration-300 shadow-sm dark:shadow-none group"
          >
